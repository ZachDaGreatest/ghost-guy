...
class ghost():
    def __init__(self, type_info, type, pos):
        # based on the supplied type the ghost retrieves its stats
    ...
    # this function is used everyframe and handles movement, attacking, ect.
    ...
    # damage runs whenever a ghost is hit
    def damage(self, damage, id_number):
        # the id number makes sure that a piercing bullet can't damage the same ghost
